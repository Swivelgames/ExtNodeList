...
java -jar $CWD/bin/compiler.jar --compilation_level WHITESPACE_ONLY --js $CWD/extnodelist.js --js_output_file $CWD/extnodelist.min.js #--create_source_map=$CWD/javascript-assets/library/minified/pure-modals.min.map
wait $!